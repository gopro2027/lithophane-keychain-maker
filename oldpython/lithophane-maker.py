...
class Window(QMainWindow):
    ...
    def showImagePicker(self):
        qimage = QFileDialog.getOpenFileName(None,'OpenFile','C:\\',"Image file(*png)")
        self.imageView.setVisible(1)
        self.imageView.setPixmap(QPixmap(qimage[0]).scaledToWidth(400))
        self.glWidget.updateImage(qimage[0], False)

        #qimage = "C:\\Users\\Tyler\\Downloads\\7272738621.png"
        #self.imageView.setVisible(1)
        #self.imageView.setPixmap(QPixmap(qimage).scaledToWidth(400))
        #self.glWidget.updateImage(qimage)
    
    def pickImage(self,img, rembg):
        self.imageView.setVisible(1)
        self.imageView.setPixmap(QPixmap(img).scaledToWidth(400))
        self.glWidget.updateImage(img,rembg)
    ...
    def exportSTL(self, filename):
        print(filename)
        self.glWidget.generateSTL(filename)
...
if __name__ == '__main__':
    ...
    #qimage = 'testcar.jpg'
    #glWidget.updateImage(qimage)
    #glWidget.generateSTL('C:\\Users\\Tyler\\Documents\\GitHub\\lithophane-maker\\output.STL')
    ...
    #inputimg = 'drewbike-removebg.png'
    inputimg = 'logal.jpg'
    mainWindow.pickImage(inputimg, False)
    mainWindow.exportSTL('output/'+inputimg+'.STL')
